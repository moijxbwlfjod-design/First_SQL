...
CREATE TABLE `doctors` (
  ...
  CONSTRAINT `doctors_ibfk_1` FOREIGN KEY (`departement_id`) REFERENCES `departements` (`departement_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `patients` VALUES (1,'Alex','Johnson','Male','1990-06-15','1234567890','example@gmail.com',NULL);
...
CREATE TABLE `staffs` (
  ...
  KEY `departement_id` (`departement_id`),
  CONSTRAINT `staffs_ibfk_1` FOREIGN KEY (`departement_id`) REFERENCES `departements` (`departement_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-02 16:03:40
